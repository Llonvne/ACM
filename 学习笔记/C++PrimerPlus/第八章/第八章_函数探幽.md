...
但是可以**提供一个具体化函数定义--称为显示具体化**。其中包含所需的代码，**编译器会优先使用与函数调用匹配的具体化函数定义**。而不在寻找模版。

**第三方具体化(ISO/ANSI C++标准)**

* 对于给定的函数名可以有非模版函数，模版函数，显示具体化函数和他们的重载版本
* 显示具体化的函数原型和定义应以template<>打头，通过名称来指出类型
...
我们必须要再次提及**在代码中包含函数模版本身并不会生成函数定义，他只是一个用于生成函数定义的方案**



![截屏2022-02-09 下午1.47.21](https://tva1.sinaimg.cn/large/008i3skNly1gz79my9ajkj30vl0u0jth.jpg)

![截屏2022-02-09 下午1.47.07](https://tva1.sinaimg.cn/large/008i3skNly1gz79mywxuej30vl0u0goj.jpg)

![截屏2022-02-09 下午12.58.30](https://tva1.sinaimg.cn/large/008i3skNly1gz79n0de08j30vl0u0q7w.jpg)

![截屏2022-02-09 下午12.58.27](https://tva1.sinaimg.cn/large/008i3skNly1gz79mzdwrqj30vl0u0tdm.jpg)
